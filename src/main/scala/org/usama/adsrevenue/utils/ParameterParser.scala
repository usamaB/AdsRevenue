package org.usama.adsrevenue.utils
...
object ParameterParser {
  ...
  /**
    ...
    * In case of Failure prints error and exits the system else return AppParameters
    */
  def parse(args: Array[String]): AppParameters = {
    getCommand.parse(args.toIndexedSeq) match {
      case Left(help) =>
